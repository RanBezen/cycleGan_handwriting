        ...
        for epoch in range(epochs):
            for batch_i, (imgs_A, imgs_B) in enumerate(self.data_loader.load_batch(batch_size)):
                ...
                if batch_i % sample_interval == 0:
                    ...
                    self.d_A.save('saved_model/cycDiscA_1.h5')
                    self.d_B.save('saved_model/cycDiscB_1.h5')
                    self.g_AB.save('saved_model/cycGenAB_1.h5')
                    self.g_BA.save('saved_model/cycGenBA_1.h5')
                    print('model saved')
